...
3. 面试主要还是看重表现，可以练习“吹牛”。见过很多简历水的不行的，分数反而很高。  
4. 英语面试最好练练，不要纯背稿。有的学校很看重，毕竟面试分数差距不大，可能1分就能决定结果。  
5. 导师选择建议：  
   - 985 + 工业界热门方向强导（岗位米多）+ 放实习  
   - 一线城市 + 985 + 羊导  
   （考公的除外，羊导貌似考公也合适）  
   注：羊导属于稀缺资源，可能被本校学生提前锁。  
